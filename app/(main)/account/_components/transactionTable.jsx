...
const TransactionTable = ({ transactions }) => {
    ...
    const filteredAndSortedTransacctions = useMemo(() => {
    ...
    const handleSelectAll = () => {
        setSelectedIds((current) =>
            current.length === filteredAndSortedTransacctions.length ? [] : filteredAndSortedTransacctions.map((t) => t.id)
        )
    }
        ...
        <Table>
            <TableHeader>
                ...
                <TableHead className="w-[50px]">
                    <Checkbox onCheckedChange={handleSelectAll} checked={
                        selectedIds.length === filteredAndSortedTransacctions.length && filteredAndSortedTransacctions.length > 0
                    }/>
                </TableHead>
                        ...
                        <TableCell>
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent>
                                    ...
                                    <DropdownMenuItem 
                                        className='text-destructive' onClick={() => deleteFn([transaction.id])}
                                    >
                                        Delete
                                    </DropdownMenuItem>
                                </DropdownMenuContent>
