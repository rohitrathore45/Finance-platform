...
export default function Home() {
  return <div className="mt-40">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {statsData.map((statsData, index) => (
            <div key={index} className="text-center">
              <div className="text-blue-600 mb-2 font-bold text-4xl">{statsData.value}</div>
    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Everything ypu need to manage your finances</h2>
    ...
    <section className="py-20 bg-blue-600">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already managing thier finances smarter with Welth
        </p>
        <Link href="/dashboard">
